...
class BudgetSpentTotalsTest {
    ...
    @Test
    fun `spent totals reflect transaction amounts`() =
        runBlocking {
            val categoryId =
    ...
    @Test
    fun `spent totals are zero when no transactions exist`() =
        runBlocking {
    ...
    @Test
    fun `budget spent and remaining summarize expense and income totals`() =
        runBlocking {
            ...
            // remaining = incomeTransactions(3000) - expenseTransactions(100)
